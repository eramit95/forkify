...
import { getSearchInput } from "../views/searchView";
...
export default class Recipe {
    ...
    async getRecipe() {
        try {
            ...
            this.author = recipeDetails.publisher;
            this.img = recipeDetails.image_url;
            this.url = recipeDetails.source_url;
    ...
    parseIngredients() {
        ...
        this.ingredients = this.ingredients.map(element => {
            ...
            unitsLong.forEach((unit, index) => {
                element.toLowerCase().replace(unit, unitsShort[index]);
            })
